...
import ReceptionWardTableSignIn from "../components/signin/receptionWardTable";
//++++++++++++++++++++++++++++++++++++++++
  ...
  return (
   ...
   {/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/}
       <table
            ...
            style={{ margin: "20px", border: "solid", width: "500px" }}
          >
            ...
            <tbody className="tableBody" style={{ backgroundColor: "bisque" }}>
              {wards.map((ward) => {
                return <ReceptionWardTableSignIn ward={ward} />;
              })}
            </tbody>
          </table> 
